...
function UserProfile() {
  ...
  const uploadImage = async (e) => {
    ...
    if (image) {
      ...
      setImage("");
      toast.error("upload only one image", {
        position: "top-center",
      });
    }
  };
  ...
  return (
    ...
    <div style={{
      ...
      <div className="propage" style={{ textAlign: "center" }}>
        <h1
          style={{
            fontSize: "36px",
            color: "red",
        ...
        <div className="prodata" style={{ marginTop: "20px" }}>
          <h3
            style={{
              fontSize: "24px",
              fontWeight: "bold",
              marginBottom: "10px",
              fontFamily:
                "'Franklin Gothic Medium', 'Arial Narrow', Arial, Impact, Haettenschweiler, 'Arial Narrow Bold', sans-serif",
              marginLeft: "100px",
              color: "red",
            }}
          >
